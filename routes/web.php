...
Route::get('agentskyc', [HomeController::class, 'agentkyc'])->name('agentskyc');
Route::get('agentkyc', [HomeController::class, 'agentkycDetails'])->name('agentkyc.show');
...
Route::get('search-agent', [HomeController::class, 'searchAgentPage'])->name('search-agent');
...
Route::group(['as' => 'user.', 'prefix' => 'user'], function () {
    ...
    Route::post('use-code', [PaymentController::class, 'useCode'])->name('purchase.code');

    Route::get('purchase-package/{id}/{code?}', [PaymentController::class, 'purchase'])->name('purchase.package');
...
Route::group(['as' => 'admin.', 'prefix' => 'admin'], function () {
    ...
    //Route::post('/changeState', [TownshipController::class, 'changeState'])->name('changeState');
    Route::post('/changeState', [TownshipController::class], 'state')->name('changeState');

    Route::post('submit-post', [TownshipController::class, 'submitPost'])->name('postSubmit');
    ...
    Route::get('agentskyc', [UserController::class, 'index'])->name('agentskyc');
    Route::get('agentskyc-show/{id}', [UserController::class, 'show'])->name('agentskyc.show');
    Route::get('agentskyc-status/{id}', [UserController::class, 'changeStatuskyc'])->name('agentskyc.status');
    Route::get('agentskyc-delete/{id}', [UserController::class, 'destroy'])->name('agentskyc.delete');



    //Info de kyc en propiedades

    Route::get('agents2', [AdminPropertyController::class, 'index'])->name('agents2');
    Route::get('agents2-show/{id}', [AdminPropertyController::class, 'show'])->name('agents2.show');
    Route::get('agentskyc2-status/{id}', [AdminPropertyController::class, 'changeStatuskyc2'])->name('agentskyc2.status');
    ...
    // Promotional codes
    Route::get('promotional-codes',                          [PromoCodeController::class, 'index'])->name('promotional-code.index');
    Route::get('promotional-codes/create',                   [PromoCodeController::class, 'create'])->name('promotional-code.create');
    Route::post('promotional-codes/store',                    [PromoCodeController::class, 'store'])->name('promotional-code.store');
    Route::get('promotional-codes/{promotionalCode}',        [PromoCodeController::class, 'show'])->name('promotional-code.show');
    Route::get('promotional-codes/{promotionalCode}/edit',   [PromoCodeController::class, 'edit'])->name('promotional-code.edit');
    Route::post('promotional-codes/{promotionalCode}/update', [PromoCodeController::class, 'update'])->name('promotional-code.update');
});
