            ...
            <div class="row">
              ...
              <div class="col-12">
                <div class="wsus__property_input">
                    ...
                    <small>Es el título que aparece en los resultados de búsqueda de motores como Google. Debe ser conciso, relevante y atractivo.</small>
                </div>
              </div>
              <div class="col-xl-12">
                <div class="wsus__property_input">
                    ...
                    <small>Es un breve resumen que aparece debajo del título SEO en los resultados de búsqueda. Es tu oportunidad para describir de qué trata la página y convencer al lector de que haga clic en tu enlace.</small>
                </div>
              </div>
              <div class="col-12">
