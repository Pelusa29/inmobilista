            ...
            <div class="col-xl-3 col-sm-6 col-lg-4">
                <div class="wsus__single_team">
                    <div class="wsus__single_team_img">
                        ...
                        <ul class="team_link">
                            @if ($agent->link_one)
                                <li><a href="{{ $agent->link_one }}"><i class="fab fa-instagram"></i></a></li>    
                            @endif
            
                            @if ($agent->link_two)
                                <li><a href="{{ $agent->link_two }}"><i class="fab fa-youtube"></i></a></li>    
                            @endif
                            
                            @if ($agent->link_three)
                                <li><a href="{{ $agent->link_three }}"><i class="fab fa-facebook"></i></a></li>    
                            @endif
                            
                            @if ($agent->link_four)
                                <li><a href="{{ $agent->link_four }}"><i class="fab fa-tiktok"></i></a></li>    
                            @endif                            
                        </ul>
                    </div>
                    <h4>
                        <a href="{{ route('agent.show',['user_type' => '2','user_name'=>$agent->slug]) }}" style="color:#450083;">{{ $agent->name }}</a>
                    </h4>
                    <p>
                        <a href="{{ route('agent.show',['user_type' => '2','user_name'=>$agent->slug]) }}" style="color:#450083;">{{ $agent->address ?? "ND" }}</a>
                    </p>
                </div>
            </div>
        @endforeach
