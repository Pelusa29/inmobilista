                    ...
                    <form id="loginFormSubmit">
                        ...
                        <div class="form-group">
                            <div class="input-group input-group-lg">
                                ...
                                <div class="input-group-prepend">
                                    <span class="input-group-text" id="togglePassword" style="background:#FFF !important;border-left-color:#FFF;cursor:pointer;" onclick="toggleLoginPassword()">
                    ...
                    <form id="registerFormSubmit">
                        ...
                        <div class="form-group">
                            <div class="input-group input-group-lg">
                                ...
                                <div class="input-group-prepend">
                                    <span class="input-group-text" id="togglePassword" style="background:#FFF !important;border-left-color:#FFF;cursor:pointer;" onclick="toggleRegisterPassword()">
                                        <i class="fas fa-eye"></i>
                                    </span>
                                </div>
                            </div>
