...
@section('admin-content')
    ...
    <div class="row">
        <div class="col-md-12">
            <form action="{{ route('admin.promotional-code.update', $promotionalCode->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                        ...
                        <div class="row">
                            <div class="col-12 col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="promotional_code" class="form-control" id="promotional_code" value="{{ $promotionalCode->promotional_code }}">
                                </div>
                            </div>
                            <div class="col-12 col-md-4">
                                <div class="form-group">
                                    ...
                                    <select name="package_id" class="form-control" id="package_id">
                                        ...
                                        @foreach ($packages as $package)
                                            <option value="{{ $package->id }}" {{ $promotionalCode->package_id == $package->id ? "selected" : "" }}>{{ $package->package_name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            <div class="col-12 col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="date" name="expiration_date" class="form-control" id="expiration_date" value="{{ $promotionalCode->expiration_date->toDateString() }}">
                                </div>
                            </div>
                        </div>
